...
transform2 = carla.Transform(carla.Location(x=40, y=130, z=0.5), carla.Rotation(yaw=-180))## 45 130
transform3 = carla.Transform(carla.Location(x=20, y=127, z=0.5), carla.Rotation(yaw=-180))  ##20 127
transform4 = carla.Transform(carla.Location(x=-30, y=130, z=0.5), carla.Rotation(yaw=-180))
transform5 = carla.Transform(carla.Location(x=-40, y=130, z=0.5), carla.Rotation(yaw=-180))## 45 130
transform6 = carla.Transform(carla.Location(x=-5, y=160, z=0.5), carla.Rotation(yaw=90))  ##20 127
transform7 = carla.Transform(carla.Location(x=-5, y=110, z=0.5), carla.Rotation(yaw=90))
transform8 = carla.Transform(carla.Location(x=5, y=110, z=0.5), carla.Rotation(yaw=-91))## 45 130
transform9 = carla.Transform(carla.Location(x=5, y=160, z=0.5), carla.Rotation(yaw=-90))  ##20 127
# 设置行人的初始位置和朝向
...
vehicle4 = world.spawn_actor(blueprint, transform4)
vehicle5 = world.spawn_actor(blueprint2, transform5)
vehicle6 = world.spawn_actor(blueprint2, transform6)
vehicle7 = world.spawn_actor(blueprint, transform7)
vehicle8= world.spawn_actor(blueprint2, transform8)
vehicle9 = world.spawn_actor(blueprint2, transform9)
...
vehicle5.set_autopilot(True)
vehicle6.set_autopilot(True)
vehicle7.set_autopilot(True)
vehicle8.set_autopilot(True)
vehicle9.set_autopilot(True)
...
actor_list.append(vehicle6)
actor_list.append(vehicle7)
actor_list.append(vehicle8)
actor_list.append(vehicle9)
actor_list.append(walker1)
actor_list.append(walker2)
# 创建一个行为代理对象
agent = BasicAgent(vehicle1)

agent.set_destination(carla.Location(x=-30,y=202.22,z=0.500000))
...
while True:
    ...
    spectator.set_transform(carla.Transform(transform1.location + carla.Location(z=30),
