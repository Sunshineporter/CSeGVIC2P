...
# 设置汽车的初始位置和朝向
transform1 = carla.Transform(carla.Location(x=165,y=58.5,z=0.500000), carla.Rotation(yaw=180))
transform2 = carla.Transform(carla.Location(x=175,y=58.5,z=0.500000), carla.Rotation(yaw=180))## 45 130
transform3 = carla.Transform(carla.Location(x=143,y=62.2,z=0.500000), carla.Rotation(yaw=0))  ##20 127
# 设置行人的初始位置和朝向
walker_transform1 = carla.Transform(carla.Location(x=158, y=64.5, z=0.5), carla.Rotation(yaw=-90))
...
walker_controller1.set_max_speed(0.75)  # Between 1 and 2 m/s (default is 1.4 m/s).
# 开启控制
...
agent.set_destination(carla.Location(x=132.22,y=57.5,z=0.500000))
...
while True:
    ...
    spectator.set_transform(carla.Transform(transform1.location + carla.Location(z=18.2),
