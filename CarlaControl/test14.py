...
transform2 = carla.Transform(carla.Location(x=5, y=150, z=0.5), carla.Rotation(yaw=-90))## 45 130
transform3 = carla.Transform(carla.Location(x=-5, y=110, z=0.5), carla.Rotation(yaw=90))  ##20 127
# 设置行人的初始位置和朝向
...
walker_controller1.set_max_speed(0.7)  # Between 1 and 2 m/s (default is 1.4 m/s).
# 开启控制
...
agent.set_destination(carla.Location(x=5,y=110,z=0.500000))
cur_distance = 0
while True:
