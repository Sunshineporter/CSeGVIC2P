...
# 设置汽车的初始位置和朝向
transform1 = carla.Transform(carla.Location(x=170,y=58.5,z=0.500000), carla.Rotation(yaw=180))
transform2 = carla.Transform(carla.Location(x=180,y=58.5,z=0.500000), carla.Rotation(yaw=180))## 45 130
