...
# 设置汽车的初始位置和朝向
transform1 = carla.Transform(carla.Location(x=38.5, y=130, z=0.5), carla.Rotation(yaw=-180))
transform2 = carla.Transform(carla.Location(x=5, y=110, z=0.5), carla.Rotation(yaw=-90))## 45 130
transform3 = carla.Transform(carla.Location(x=5, y=150, z=0.5), carla.Rotation(yaw=-90))  ##20 127
# 设置行人的初始位置和朝向
...
agent.set_destination(carla.Location(x=-30,y=130,z=0.500000))
